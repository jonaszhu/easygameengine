...
class TheoraPlayerExport OpenAL_AudioInterface : public TheoraAudioInterface, TheoraTimer
{
	int mMaxBuffSize;
	int mBuffSize;
	short *mTempBuffer;
...
class TheoraPlayerExport OpenAL_AudioInterfaceFactory : public TheoraAudioInterfaceFactory
{
public:
