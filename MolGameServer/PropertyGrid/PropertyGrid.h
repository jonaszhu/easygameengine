...
public:
  ...
  // customization
  void SaveTOTxt(HSECTION hs, CString cstrPath);
 // void GetItemNames(HSECTION hs,KTStringArray &strNames);
  bool GetShadeTitles();
...
protected:
  ...
  friend bool item_alpha_sort(vector<CItem>::iterator it1, vector<CItem>::iterator it2);
