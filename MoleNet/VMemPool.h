...
//====================================================================
template <class objT,DWORD _dwPoolSizeT = 10000>
class CVMemPool  
{
public:
	//===========================================================
...
template <class T,DWORD F> typename CBitSet CVMemPool<T,F>::ms_bsAllocSet;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwSrtFree;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwEndFree;
template <class T,DWORD F> typename BOOL CVMemPool<T,F>::ms_bEmptyFree;
template <class T,DWORD F> typename BOOL CVMemPool<T,F>::ms_bFullFree;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwTotalSize;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwFreeQueueSize;
template <class T,DWORD F> typename char* CVMemPool<T,F>::ms_pData;

template <class T,DWORD F> typename CVMemPool<T,F>::CSLock CVMemPool<T,F>::ms_csLock;
template <class T,DWORD F> typename char*	CVMemPool<T,F>::ms_pMemPool = NULL;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwObjSize;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwAllocObjCount;
template <class T,DWORD F> typename DWORD CVMemPool<T,F>::ms_dwPoolSize;
