...
CCreateGameDlg::CCreateGameDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCreateGameDlg::IDD, pParent),m_ServerSet(NULL)
{
}
...
BEGIN_MESSAGE_MAP(CCreateGameDlg, CDialog)
	ON_WM_CREATE()
	ON_MESSAGE(WM_PG_ITEMCHANGED,&CCreateGameDlg::OnProcessPropertyGridChanged)
END_MESSAGE_MAP()


// CCreateGameDlg 消息处理程序
/**
 * 显示服务器属性
 *
 * @param pServerSet 要显示的服务器设置
 */
void CCreateGameDlg::DisplayServerSet(ServerSet *pServerSet)
{
...
LRESULT CCreateGameDlg::OnProcessPropertyGridChanged(WPARAM wparam, LPARAM lparam)
{
...
int CCreateGameDlg::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
