...
/** Constructor
 */
CMolCircularBuffer::CMolCircularBuffer()
{
 ...
 */
bool CMolCircularBuffer::Read(void * destination, size_t bytes)
{
	if (m_buffer == NULL)
		return false;
...
void CMolCircularBuffer::AllocateB()
{
	//printf("[allocating B]\n");
 ...
 */
bool CMolCircularBuffer::Write(const void * data, size_t bytes)
{
	if (m_buffer == NULL)
		return false;
 ...
 */
size_t CMolCircularBuffer::GetSpace()
{
	if( m_regionBPointer != NULL )
 ...
 */
size_t CMolCircularBuffer::GetSize()
{
 ...
 */
size_t CMolCircularBuffer::GetContiguiousBytes()
{
 ...
 */
void CMolCircularBuffer::Remove(size_t len)
{
 ...
 */
void * CMolCircularBuffer::GetBuffer()
{
	if( m_regionBPointer != NULL )
 ...
 */
void CMolCircularBuffer::Allocate(size_t size)
{
	m_buffer = (unsigned __int8*)malloc(size);
 ...
 */
void CMolCircularBuffer::IncrementWritten(size_t len)			// known as "commit"
{
	if( m_regionBPointer != NULL )
		m_regionBSize += len;
	else
 ...
 */
void * CMolCircularBuffer::GetBufferStart()
{
	if( m_regionASize > 0 )
