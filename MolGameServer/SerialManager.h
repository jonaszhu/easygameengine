...
public: 
public: 
	int GetFinalData(BYTE cardnum[], BYTE finaldata[],int narcardSize,int narfinalSize=12); 
	...
	CString& GetMachineCode(){return m_strMachineCode;} 
...
private: 
	...
	void CardNumToData(CString cardnum, BYTE data[], int nSize=16); 
	...
	void CardNumToData(BYTE cardnum[],BYTE data[],int narcardSize,int ndataSize=16); 
}; 
